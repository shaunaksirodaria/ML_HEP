...
// Mon Jul 22 16:39:27 2019 by ROOT version 6.16/00
// from TTree hits/HGC rechits
// found on file: ntuple_sim_config22_pdgID11_beamMomentum50_listFTFP_BERT_EMN.root
//////////////////////////////////////////////////////////
...
#ifdef Long_cxx
Long::Long(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ntuple_sim_config22_pdgID11_beamMomentum50_listFTFP_BERT_EMN.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ntuple_sim_config22_pdgID11_beamMomentum50_listFTFP_BERT_EMN.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("ntuple_sim_config22_pdgID11_beamMomentum50_listFTFP_BERT_EMN.root:/rechitntupler");
...
Int_t Long::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Long::LoadTree(Long64_t entry)
{
