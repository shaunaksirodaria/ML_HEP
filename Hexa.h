...
// Fri Jun 21 11:59:17 2019 by ROOT version 6.16/00
...
Int_t Hexa::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Hexa::LoadTree(Long64_t entry)
{
