...
// Mon Jul 15 15:46:39 2019 by ROOT version 6.16/00
...
Int_t Anax::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Anax::LoadTree(Long64_t entry)
{
