...
// Thu Jun 20 15:57:07 2019 by ROOT version 6.16/00
// from TTree hits/HGC rechits
// found on file: /eos/cms/store/group/dpg_hgcal/tb_hgcal/2018/cern_h2_october/offline_analysis/sim_ntuples/v2/withMCP/EMN/noAngle/ntuple_sim_config22_pdgID11_beamMomentum50_listFTFP_BERT_EMN.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *rechit_TS5High;
   vector<float>   *rechit_TS5Low;
   ...
   TBranch        *b_rechit_TS5High;   //!
   TBranch        *b_rechit_TS5Low;   //!
...
#ifdef AnaHits_cxx
AnaHits::AnaHits(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/dpg_hgcal/tb_hgcal/2018/cern_h2_october/offline_analysis/sim_ntuples/v2/withMCP/EMN/noAngle/ntuple_sim_config22_pdgID11_beamMomentum50_listFTFP_BERT_EMN.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/dpg_hgcal/tb_hgcal/2018/cern_h2_october/offline_analysis/sim_ntuples/v2/withMCP/EMN/noAngle/ntuple_sim_config22_pdgID11_beamMomentum50_listFTFP_BERT_EMN.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/dpg_hgcal/tb_hgcal/2018/cern_h2_october/offline_analysis/sim_ntuples/v2/withMCP/EMN/noAngle/ntuple_sim_config22_pdgID11_beamMomentum50_listFTFP_BERT_EMN.root:/rechitntupler");
...
Int_t AnaHits::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t AnaHits::LoadTree(Long64_t entry)
{
...
void AnaHits::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("rechit_TS5High", &rechit_TS5High, &b_rechit_TS5High);
   fChain->SetBranchAddress("rechit_TS5Low", &rechit_TS5Low, &b_rechit_TS5Low);
...
void AnaHits::Show(Long64_t entry)
{
...
Int_t AnaHits::Cut(Long64_t entry)
{
