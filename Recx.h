...
// Wed Jul 17 15:01:22 2019 by ROOT version 6.16/00
...
Int_t Recx::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Recx::LoadTree(Long64_t entry)
{
